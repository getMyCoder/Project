...
var defense = {
    ...
    teamRankData: function (data) {
        ...
        for (var p = 0; p < this.parameter.teamData.data.length; p++) {
            if (this.parameter.teamData.data[p].value<=0){
                this.parameter.teamData.data[p].value=0
            }
    ...
    distributionEchart: function (id, data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            select.data.push([data[i].name.substring(0,5), data[i].value]);
            select.str.push(data[i].name.substring(0,5));
        }
        ...
        var option = {
            ...
            tooltip: {
                ...
                formatter: function (val) {
                    return select.title[val.dataIndex]+':'+val.value[1]
                }
            },
            grid: {
                left: '10%',
    ...
    rankingEchart: function (id, data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            allData.title.push(data[i].name.substring(0,3));
        }
        var myChart = echarts.init(document.getElementById(id));
        var option = {
            tooltip: {
                ...
                formatter: function (val) {
                    return allData.name[val.dataIndex]+':'+val.value
                }
            },
            grid: {
                left: '20%',
